export const token = {
  shell: "h-screen w-screen overflow-hidden bg-[#eef0f8] text-[#263445]",
  ...
  button:
    "inline-flex h-8 items-center justify-center gap-1 whitespace-nowrap rounded-[3px] border px-3 text-sm font-medium leading-none transition disabled:cursor-not-allowed disabled:opacity-50",
  ...
  tab: "h-9 border-r border-[#e6ebf3] px-4 text-sm",
