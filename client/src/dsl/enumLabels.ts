export const enumValueLabels: Record<string, Record<string, string>> = {
  ...
  funds_allocation_method: { byCpPaidRatio: "按合同产品应收比例", byCpRemainingAmount: "按合同产品剩余金额比例", oldestContractFirst: "优先最早合同", manual: "手工分配" },
  allocation_split_by: { contract_product: "合同产品", contract: "合同", organization: "校区", product_type: "产品类型" },
  generated_log_table: { money_arrange_log: "资金分配记录", promotion_arrange_log: "优惠分配记录", performance_arrange_log: "业绩分配记录" },
  performance_allocation_method: { byCpPaidRatio: "按合同产品实收比例", byCpReceivableRatio: "按合同产品应收比例", oneToOneFirst: "优先一对一", classCourseFirst: "优先班课", salesOwnerOnly: "归属签约顾问" },
  product_priority: { none: "不区分", oneToOneFirst: "一对一优先", classCourseFirst: "班课优先", oneOnNFirst: "一对N优先" },
  promotion_allocation_method: { byCpAmountRatio: "按合同产品金额比例", byCpHourRatio: "按合同产品课时比例", oneToOneFirst: "优先一对一产品", classCourseFirst: "优先班课产品", manual: "手工分配" },
  refund_allocation_method: { byCpRemainingAmount: "按产品剩余金额比例", originalPaymentReverse: "按原收款反向冲减", manual: "手工指定" },
